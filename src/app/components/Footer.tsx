    ...
    <footer className="border-t border-[#1A1A1A] bg-[#0A0A0A]">
      <div className="mx-auto max-w-6xl px-5 py-10">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
          <div className="col-span-2 md:col-span-1">
            ...
            <p className="text-xs text-[#666] leading-relaxed">
              21 essential developer tools. Zero dependencies. Full TypeScript. Works in Node.js and the browser.
            </p>
          </div>
        ...
        <div className="mt-8 pt-4 border-t border-[#1A1A1A] flex items-center justify-between">
          ...
          <p className="text-[11px] text-[#555] font-mono">{SITE_VERSION}</p>
        </div>
      </div>
    </footer>
  );
