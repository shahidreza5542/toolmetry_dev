...
export function ToolCard({ slug, name, icon, category, description }: ToolCardProps) {
  ...
  return (
    <Link href={`/docs/${slug}`}>
      <div className="group relative rounded-xl border border-border bg-card p-5 transition-all duration-200 hover:border-brand/40 hover:shadow-lg hover:shadow-brand/5 h-full">
